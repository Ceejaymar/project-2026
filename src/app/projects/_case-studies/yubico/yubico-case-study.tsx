      ...
      <div className={styles.caseStudyScope}>
        ...
        <div className={styles.content}>
          <CaseStudySection title="Overview">
            <p>
              Yubico’s product finder helps people choose a security key without requiring everyone
              to begin with the same level of technical knowledge. Visitors choose a starting point
              based on their familiarity and purchase context, answer a tailored set of questions,
              and receive a product recommendation or a clear next step.
            </p>
          </CaseStudySection>
          ...
          <CaseStudySection title="My role" spacing="compact">
            <p>
              The broader quiz structure and visual direction were already underway when I joined. I
              worked closely with UX and design to clarify incomplete rules, work through unclear
              questions and states, and turn the flow into a responsive, accessible React
              experience.
            </p>

            <CaseStudyCallout label="Role focus">
              I owned the frontend implementation, conditional flow logic, responsive behavior, and
              accessibility, then later added Cypress coverage for key quiz paths.
            </CaseStudyCallout>
          </CaseStudySection>
          ...
          <CaseStudySection title="Helping people answer technical questions" spacing="spacious">
            <div className={styles.questionLayout}>
              <p>
                Each path uses a different set of questions, so beginners are not forced through the
                same level of detail as experienced buyers. Supporting information sits alongside
                the flow to explain terminology, clarify what a question is asking, and provide
                relevant Yubico context when it helps someone answer with more confidence.
              </p>
            </div>
          ...
          <CaseStudySection title="From answers to the right next step" spacing="spacious">
            <div className={styles.nextStepLayout}>
              <p>
                ...
                purchase needs, the experience can move from product guidance to Customer Success at
          ...
          <CaseStudySection title="What I learned" spacing="spacious">
            ...
            <p>
              The project reinforced that a product finder is not just a multi-step form. The order
              of questions, amount of explanation, and quality of each branch all shape whether
              someone feels guided or overwhelmed.
            </p>
          </CaseStudySection>
        </div>
      </div>
